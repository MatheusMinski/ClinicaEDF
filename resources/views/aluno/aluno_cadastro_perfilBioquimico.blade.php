    ...
    <div class="container" >
        ...
        <div id="cadastro">
            <form method="post" action="{{route('salvar.professor')}}">
                ...
                <input value=""  id = "Data" name="glicemiaDataDois" class="form-control"  required="required" maxlength="50" placeholder="00/00/0000" />
                <br/><br/>
                ...
                <br/><br/>
                <label for="">Data 1</label>
                <input value="" name="insulinaDataUm" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000"/>
                <br/><br/>
                <label for="">Valor 1</label>
                <input value="" name="insulinaValorUm" class="form-control"  required="required" maxlength="50" type="text" placeholder="" />
                <br/><br/>
                <label for="">Data 2</label>
                <input value="" name="insulinaDataDois" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 2</label>
                ...
                <br/><br/>
                <label for="">Data 1</label>
                <input value="" name="creatinaDataUm" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 1</label>
                <input value="" name="creatinaValorUm" class="form-control"  required="required" maxlength="50" type="text" placeholder="" />
                <br/><br/>
                <label for="">Data 2</label>
                <input value="" name="creatinaDataDois" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 2</label>
                ...
                <br/><br/>
                <label for="">Data 1</label>
                <input value="" name="ctDataUm" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 1</label>
                <input value="" name="ctValorUm" class="form-control"  required="required" maxlength="50" type="text" placeholder="" />
                <br/><br/>
                <label for="">Data 2</label>
                <input value="" name="ctDataDois" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 2</label>
                ...
                <br/><br/>
                <label for="">Data 1</label>
                <input value="" name="hdlDataUm" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 1</label>
                <input value="" name="hdlValorUm" class="form-control"  required="required" maxlength="50" type="text" placeholder="" />
                <br/><br/>
                <label for="">Data 2</label>
                <input value="" name="hdlDataDois" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 2</label>
                ...
                <br/><br/>
                <label for="">Data 1</label>
                <input value="" name="ldlDataUm" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 1</label>
                <input value="" name="ldlValorUm" class="form-control"  required="required" maxlength="50" type="text" placeholder="" />
                <br/><br/>
                <label for="">Data 2</label>
                <input value="" name="ldlDataDois" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 2</label>
                ...
                <br/><br/>
                <label for="">Data 1</label>
                <input value="" name="tgDataUm" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 1</label>
                <input value="" name="tgValorUm" class="form-control"  required="required" maxlength="50" type="text" placeholder="" />
                <br/><br/>
                <label for="">Data 2</label>
                <input value="" name="tgDataDois" class="form-control"  required="required" maxlength="50" id = "Data" placeholder="00/00/0000" />
                <br/><br/>
                <label for="">Valor 2</label>
